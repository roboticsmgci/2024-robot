...
public final class Constants {
  ...
  public static class DrivetrainConstants {
    ...
    // Source for gear ratios: https://www.swervedrivespecialties.com/products/mk4i-swerve-module
    // Turn ratios are the same for the MK4i no matter if L1, L2, L3
    public static final double kTurnGearRatio = 1.0 / (150.0 / 7.0);
    // MK4i L1
    public static final double kDriveGearRatio = 1.0 / ((14.0 / 50.0) * (25.0 / 19.0) * (15.0 / 45.0));
    // MK4i L2
    ...
    public static final double kFrontLeftTurnEncoderOffset = 231.24; // TODO: should be the value of the encoder when the wheel is facing forward
