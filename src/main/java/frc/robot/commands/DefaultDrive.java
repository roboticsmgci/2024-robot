...
public class DefaultDrive extends Command {
   ...
   */
  public DefaultDrive(SwerveSubsystem swerve, DoubleSupplier vX, DoubleSupplier vY, DoubleSupplier headingAdjust,
  ...
  public void execute() {
    ...
    translation = SwerveMath.limitVelocity(translation, swerve.getFieldVelocity(), swerve.getPose(),
        DrivetrainConstants.kLoopTime, DrivetrainConstants.kRobotMass, DrivetrainConstants.kChassis,
    ...
    if (headingX == 0 && headingY == 0 && Math.abs(headingAdjust.getAsDouble()) > 0) {
      resetHeading = true;
      swerve.drive(translation, (Constants.OperatorConstants.kTurnConstant * -headingAdjust.getAsDouble()), true);
    } else {
